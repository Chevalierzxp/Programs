...
public abstract class Vehicle implements Runnable {
    ...
    private int                	speed;
    private Log 				log;
    private boolean hasAmb;
    private Lock lock = new ReentrantLock();
	public Condition waitTime = lock.newCondition();
	public Condition ambInTunnel = lock.newCondition();
        ...
        try {
             if(this instanceof Ambulance){
            	 ...
            	 while(wTime > 0){
            		 ...
            		 else if(wTime > signalTime){
            			 long startTime = System.currentTimeMillis();
            			 wTime = wTime - signalTime;
            			 waitTime.await(wTime, TimeUnit.MILLISECONDS);
